...
const string strMessageMagic = "FX Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    else if (nHeight > 1 && nHeight <= 5000) {
        nSubsidy = 2 * COIN;
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    if (pindexPrev->nHeight > 1 && pindexPrev->nHeight <= 5000) {
        nSubsidy = 2 * COIN;
    } else if(pindexPrev->nHeight > 5000 && pindexPrev->nHeight <= 10000) {
        nSubsidy = 3 * COIN;
    } else if(pindexPrev->nHeight > 10000 && pindexPrev->nHeight <= 25000) {
        nSubsidy = 4 * COIN;
    } else if(pindexPrev->nHeight > 25000 && pindexPrev->nHeight <= 50000) {
        nSubsidy = 5 * COIN;
    } else if(pindexPrev->nHeight > 50000 && pindexPrev->nHeight <= 100000){
        nSubsidy = 3 * COIN;
    }
