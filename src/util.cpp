...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\FX
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\FX
    // Mac: ~/Library/Application Support/FX
    // Unix: ~/.fxcoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "FX";
#else
    fs::path pathRet;
