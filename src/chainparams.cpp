...
public:
    CMainParams() {
        ...
        vout.resize(1);
        vout[0].SetEmpty();
//        CPubkey vPubKey = ParseHex("");
//        vout[0].scriptPubKey =
        CTransaction txNew(1, 1567430390, vin, vout, 0);
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime    = 1567430390;
        ...
        assert(hashGenesisBlock == uint256("0x000094122ff718f6dbe804d8e0a8893a4cbd02e99b84ce248e6992310cf631e0"));
        assert(genesis.hashMerkleRoot == uint256("0x479af78427c89f70468afcbed53712994dafe7e9ceffbb6840f321785a5842de"));
        ...
        vSeeds.push_back(CDNSSeedData("1","199.247.9.42"));//seeds
		vSeeds.push_back(CDNSSeedData("2","45.76.151.224"));
		vSeeds.push_back(CDNSSeedData("3","164.68.97.79"));

        convertSeeds(vFixedSeeds, pnSeed, ARRAYLEN(pnSeed), nDefaultPort);

        nPoolMaxTransactions = 3;
        strDarksendPoolDummyAddress = "FRXeohCpN5mASju3A78trDnmhsDsf1oaSi";
        nLastPOWBlock = 50000;
        nPOSStartBlock = 101;
    }
