...
private slots:
    ...
    QString BuyFX(QString OrderType, double Quantity, double Rate);
    QString SellFX(QString OrderType, double Quantity, double Rate);
